...
p4 <- readRDS (f_fig1_lic) |>
    mutate (lty = (what == "cran_by_year")) |>
    ggplot (aes (x = year, y = n, lty = lty)) +
    geom_line () +
    theme (legend.position = "none") +
    ylab ("Number of distinct licenses") +
    ggtitle ("D: Num licenses")

png (fig01_png, width = 7, height = 7, units = "in", res = 300)
(p1 + p2) / (p3 + p4)
graphics.off ()
```

```{r fig1-num_aut_ctb2, echo = FALSE, out.width = 700, fig.cap = "**Figure 1.** Annual developments of CRAN package submissions (A), and of metadata from package 'DESCRIPTION' files (B-D)."}
