...
plus (not covered in this talk) ...

- Modular system for adaptation to other standards

- Graded assessment

- Dynamic compliance against evolving standards
...
- A "roclet" is a documentation engine ("doclet") for the **R** language.
...
- Software must comply with detailed, category-specific standards

- `srr` allows standards compliance to be documented within the software itself
...
## documentation in R with 'roxygen2'
...
- Tags with `output = NULL` do not appear in package documentation
...
- `srr` introduces 3 new tags for documenting standards:
