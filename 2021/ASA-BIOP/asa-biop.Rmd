...
---
class: center, middle, inverse
background-image: url(img/devguide-ch15.png)
background-size: contain
background-position: 50% 50%
...
path <- file.path (here::here (), "2021", "ASA-BIOP", "demo")
code <- c ("#' my_function",
           "#'",
           "#' @param x An input",
...
library (autotest)
#path <- file.path (here::here (), "2021", "ASA-BIOPemo")
#a1 <- autotest_package (path, test = TRUE)
...
---
class: left, top
background-image: url(img/stats-devguide-stds-G1.png)
background-size: contain
background-position: 50% 50%

---
class: left, top
background-image: url(img/stats-devguide-stds-G2.png)
background-size: contain
background-position: 50% 50%

---
class: left, top
background-image: url(img/stats-devguide-stds-G3.png)
background-size: contain
background-position: 50% 50%

---
class: left, top
background-image: url(img/stats-devguide-stds-G4.png)
background-size: contain
background-position: 50% 50%

---
class: left, top
background-image: url(img/stats-devguide-stds-BS1.png)
background-size: contain
background-position: 50% 50%

---
class: left, top
background-image: url(img/stats-devguide-stds-BS2.png)
background-size: contain
background-position: 50% 50%

---
class: left, top
background-image: url(img/stats-devguide-stds-BS3.png)
background-size: contain
background-position: 50% 50%
...
library (srr)
d <- srr_stats_pkg_skeleton (pkg_name = "newpkg")
