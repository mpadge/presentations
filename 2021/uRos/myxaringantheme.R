...
write_xaringan_theme(text_color = "#000",
                     ...
                     header_font_family = "'Exo'",
                     # or Bitter, Lobster, Pacifico, Source Serif Pro, Exo,
                     # Amatic SC
                     header_font_weight = "bold",
                     #header_font_url = "https://fonts.googleapis.com/css?family=Amatic+SC",
                     header_font_url = "https://fonts.googleapis.com/css?family=Exo",
                     ...
                     extra_css = list(
                                      ".red" = list("color" = "#FF3300",
                                                    "font-weight" = "bold",
                                                    "font-size" = "200%"),
                                      ".small" = list ("font-size" = "90%"),
                                      ".large" = list ("font-size" = "130%",
                                                       "font_weight" = "bold",
                                                       "background-color" = "rgba(220,220,80,0.5)",
                                                       "color" = "#117711"),
